  ...
  describe 'POST /api/v1/place_evaluations' do
    context '入力内容が正しい場合' do
      it '場所と評価を保存できる' do
        ...
        post '/api/v1/place_evaluations', params: { place_evaluation: { place_id: place.id, visited_on: Date.today, evaluation: :good }}
    ...
    context '入力内容が正しくない場合' do
      it '場所と評価を保存できない' do
        ...
        post '/api/v1/place_evaluations', params: { place_evaluation: { place_id: place.id, visited_on: Date.tomorrow, evaluation: :good }}
